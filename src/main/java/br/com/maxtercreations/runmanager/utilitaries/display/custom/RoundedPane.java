...
import br.com.maxtercreations.runmanager.graphics.GaussianBlur;
...
public class RoundedPane extends JPanel {
	...
	protected void paintComponent(Graphics g) {
		...
		BufferedImage shadow = GaussianBlur.generateShadow(bufferedImage, shadowSize, Color.BLACK, 0.3f);
