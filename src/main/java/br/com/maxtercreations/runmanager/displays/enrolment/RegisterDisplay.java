...
public class RegisterDisplay {
	...
	public RegisterDisplay() {
		...
		JTextField birthdate = createBox("DATA DE NASCIMENTO", "DIGITE A SUA DATA DE NASCIMENTO NO CAMPO ABAIXO:", "00/00/0000", new Rectangle(835, 380, 430, 78), createMask("##/##/####", "0123456789", "00/00/0000"));
		...
		JTextField phone = createBox("TELEFONE PARA CONTATO", "DIGITE O SEU NÚMERO DE TELEFONE NO CAMPO ABAIXO:", "(00) 00000-0000", new Rectangle(57, 557, 369, 78), createMask("(##) #####-####", "0123456789", "(00) 00000-0000"));
		...
		phone.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent e) {
				...
				if (phone.getText().matches(cell) || phone.getText().matches(fix)) {
					...
					if (registerPanel.getY() != 0 && phone.getText().length() == 15)
						registerPanel.animate(5, 200, 500, registerPanel.getY() == 0 ? AnimationVector.TOP : AnimationVector.BOTTOM);
				}
		...
		JTextField name = createBox("NOME COMPLETO", "DIGITE O SEU NOME COMPLETO NO CAMPO ABAIXO:", "EX. GUSTAVO ROLIM DOS SANTOS", new Rectangle(57, 380, 670, 78));
		...
		JLabel option = new JLabel("SELECIONE A OPÇÃO EM QUE IRÁ PARTICIPAR");
		...
		String concludeText = "<html><div style='text-align: center;'>REALIZAR A<br> <font size=\"6\">MATRÍCULA</font></div></html>";
		...
		new ModernButton(concludeText, utils.getBoldFont(15), Constants.MAIN_LIGHT_COLOR, Constants.MAIN_LIGHT_COLOR, new Rectangle(973, 700, 284, 84), 70, "/buttons/medal-small.png", registerPanel, new Callback() {	
			...
			public void done() {
				...
				String domainId = manager.getRunnerManager().addRunner(name.getText(), "", phoneT, birthday, raceType, "");
				
				RunnerUtils runnerUtils = new RunnerUtils(domainId);
				
				new BarcodeRegisterDisplay(runnerUtils);
			}
		});
		
		System.out.println(raceTypeButton.firstOption());
		
		String cancelText = "<html><div style='text-align: center;'>CANCELAR<br> <font size=\"6\">CADASTRO</font></div></html>";
